// This code was generated by `SqlHydra.Sqlite` -- v3.3.0-beta.2.
...
module HydraBuilders =
    ...
    let inline selectTask ct =
        selectTask<'Selected, 'Mapped, System.Data.Common.DbDataReader, _> HydraReader.Read ct

    /// Builds a select query with a QueryContext - returns an Async query result
    let inline selectAsync ct =
        selectAsync<'Selected, 'Mapped, System.Data.Common.DbDataReader, _> HydraReader.Read ct
