...
let getCode (extensions: IExtendTypeMapping list) cfg =
    let schema = SqliteSchemaProvider.getSchema(cfg, false, extensions)
    let version = Version.get()
    SchemaTemplate.generate cfg Provider.instance schema version
