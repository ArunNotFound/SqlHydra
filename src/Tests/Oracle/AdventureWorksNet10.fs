// This code was generated by `SqlHydra.Oracle` -- v3.3.0-beta.1.
...
module HydraBuilders =
    ...
    let inline selectTask ct =
        selectTask<'Selected, 'Mapped, Oracle.ManagedDataAccess.Client.OracleDataReader, _> HydraReader.Read ct

    /// Builds a select query with a QueryContext - returns an Async query result
    let inline selectAsync ct =
        selectAsync<'Selected, 'Mapped, Oracle.ManagedDataAccess.Client.OracleDataReader, _> HydraReader.Read ct
