// This code was generated by `SqlHydra.SqlServer` -- v3.3.0.
...
module HydraBuilders =
    ...
    let inline selectTask ct =
        let b = selectTask<'Selected, 'Mapped, Microsoft.Data.SqlClient.SqlDataReader, _> HydraReader.Read ct
    ...
    let inline selectAsync ct =
        let b = selectAsync<'Selected, 'Mapped, Microsoft.Data.SqlClient.SqlDataReader, _> HydraReader.Read ct
        b.GenericReadMethod <- Some(typeof<HydraReader>.GetMethod("Read"))
        b
